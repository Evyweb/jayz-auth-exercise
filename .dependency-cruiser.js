...
module.exports = {
    forbidden: [
        ...
        },
        {
            ...
            from: {
                path: '^src/authentication/domain',
            },
            to: {
                path: '^src/authentication/infrastructure',
            },
        },
        {
            ...
            to: {
                path: '^src/authentication/application',
            },
        },
        {
            ...
            to: {
                path: '^src/authentication/presentation',
            },
        },
        {
            ...
            dot: {
                ...
                */
                theme: {
                    modules: [
                        {
                            criteria: { source: '^src/authentication/domain' },
                            attributes: {
                                fillcolor: '#dc6b0d',
                                fontcolor: 'white',
                                style: 'filled',
                        ...
                        {
                            criteria: { source: '^src/authentication/application' },
                            attributes: {
                                fillcolor: '#dd1c1c',
                                fontcolor: 'white',
                                style: 'filled',
                        ...
                        {
                            criteria: { source: '^src/authentication/infrastructure' },
                            attributes: {
                                fillcolor: '#248cea',
                                fontcolor: 'white',
                                style: 'filled',
                        ...
                        {
                            criteria: { source: '^src/authentication/presentation' },
                            attributes: {
                                fillcolor: '#20b520',
                                fontcolor: 'white',
                                style: 'filled',
